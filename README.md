...
- **Agents:** [AGENTS.md](AGENTS.md) · [llms.txt](llms.txt) · [release-guide.md](release-guide.md) · [documentation-guide.xml](documentation-guide.xml) (portable template for other repos)
