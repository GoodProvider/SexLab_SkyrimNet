...
DOM_Core Property DOM01 Auto Hidden
...
{register an actor to a device and flag it so it can be tracked.}
	...
	if DOM01 == None
		...
		endIf
	elseif Game.GetModByName("DiaryOfMine.esm") == 255
		DOM01 = None
	endif

	if DOM01 != None
		DOM01.DOMZaz.DSE_DM_RegisterActor(Who,Device,Slot)
	endif
...
{unregister an actor from a device and clean it up.}
	...
	if DOM01 != None
		DOM01.DOMZaz.DSE_DM_UnregisterActor(Who,Device,Slot)
	endif
