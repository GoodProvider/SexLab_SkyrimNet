...
- Non-Dom Combined: `name+" is orgasming. "`
- Dom Combined fallback: if orgasm expected and totals > 0 but custom text raced empty, still append `name+" is orgasming. "`
...
Combined path also builds clauses in [`Scripts/Source/SkyrimNet_SexLab_Scene.psc`](../../Scripts/Source/SkyrimNet_SexLab_Scene.psc) (`name+" is orgasming. "`).
